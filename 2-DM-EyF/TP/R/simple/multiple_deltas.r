#necesita de 64GB de memoria RAM para correr, demora 15 minutos
#limpio la memoria
...
optimo  <- list( "min_data_in_leaf" =  310000,  #tamano de hoja MONSTRUOSO
                 "num_iterations"   =     560,
                 "pcorte" =                 0.0337 )  #atencion, NO es 0.025
...
fwrite( entrega, logical01=TRUE, sep=",",  file= "~/buckets/b2/work/multiple_deltas.csv" )
