#necesita de 64GB de memoria RAM para correr, demora 10 minutos
#limpio la memoria
...
#forma bruta de calcular deltas
...
optimo  <- list( "min_data_in_leaf" =  348000,  #tamano de hoja MONSTRUOSO
                 "num_iterations"   =     750,
                 "pcorte" =                 0.0349 )  #atencion, NO es 0.025
...
fwrite( entrega, logical01=TRUE, sep=",",  file= "~/buckets/b2/work/simple_delta_is_beautiful.csv" )
