...
optimo  <- list( "min_data_in_leaf" = 215000,
                 "num_iterations"   =    400,
                 "pcorte" =                0.0382)
...
modelo  <- lgb.train(data= dgeneracion,
                     objective= "binary",
                     max_bin= 31,  #basta del default 255
...
fwrite( entrega, logical01=TRUE, sep=",",  file= "~/buckets/b2/work/simple_lag_is_beautiful_tribute.csv" )
