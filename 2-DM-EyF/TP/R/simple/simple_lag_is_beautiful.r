...
dataset <- fread("~/buckets/b1/datasetsOri/paquete_premium.txt.gz")
...
optimo  <- list( "min_data_in_leaf" =  27300,  #tamano de hoja GIGANTESCO
                 "num_iterations"   =    455,
                 "pcorte" =                0.038 )  #atencion, NO es 0.025
