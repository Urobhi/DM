...
optimo  <- list( "min_data_in_leaf" =  228000,  #tamano de hoja MONSTRUOSO
                 "num_iterations"   =     961,
                 "pcorte" =                 0.0425 )  #atencion, NO es 0.025
...
fwrite( entrega, logical01=TRUE, sep=",",  file= "~/buckets/b2/work/simple_lag_is_beautiful_power.csv" )
