...
for(vminbucket in  buckets_inteligentes )
{
  ...
  cat( "maxdepth=", vmaxdepth,
       ...
       "minbucket=", vminbucket,
       "ganancia=",  ganancia, "\n", 
       file="./work/salida_grid_search_4meses.txt", append="TRUE")
...
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="./work/rpart_basico_entrega_gridseach_4meses.csv")
