...
dtrain <-  dataset[ foto_mes>=201812 & foto_mes<=201911 , ]  #lo aplico a 12 meses
...
optimo  <- list( num_iterations= 685,
                 learning_rate=  0.009917745,
                 feature_fraction= 0.4120569,
                 min_gain_to_split= 0.9172147,
                 num_leaves=  69,
                 lambda_l1= 0.0,
                 lambda_l2=  0.0
               )
...
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="./work/lightgbm_optimo12_entrega.csv")
