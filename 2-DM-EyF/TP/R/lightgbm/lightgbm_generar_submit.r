...
dtrain <-  dataset[ foto_mes>=201904 & foto_mes<=201911 , ]
...
optimo  <- list( num_iterations= 1226 ,
                 learning_rate=  0.02004848,
                 feature_fraction=  0.3058152,
                 min_gain_to_split= 0.6018143,
                 num_leaves=  16,
                 lambda_l1= 0.004297873,
                 lambda_l2=  5.31963
               )
...
fwrite( entrega[ ,  c("numero_de_cliente", "estimulo"), with=FALSE], sep=",",  file="./work/lightgbm_optimo_entrega.csv")
