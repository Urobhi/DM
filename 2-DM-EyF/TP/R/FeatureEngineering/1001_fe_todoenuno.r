...
fwrite( dataset,
        file="./datasets/paquete_premium_ext.txt.gz",
        sep= "\t" )
...
fwrite( dataset, 
        file= "./datasets/paquete_premium_hist.txt.gz", 
        sep="\t" )
...
#al  agregarle el .gz  al final del nombre del archivo,  data.table sabe que debe comprimir el archivo
fwrite( dataset, 
        file= "./datasets/paquete_premium_exthist.txt.gz", 
        sep="\t" )
