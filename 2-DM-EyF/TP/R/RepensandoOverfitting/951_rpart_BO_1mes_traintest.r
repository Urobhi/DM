...
kexperimento <-  "951"   #cambiar esto en cada corrida !
...
x <- list( pcp=0.0, pminsplit=5, pmaxdepth=10, pminbucket= 0.05 )
...
set.seed( 200177 )  #semilla

d201906[ , azar := runif( nrow( d201906 ) ) ]
setorderv( d201906, c("clase_binaria","azar") )
d201906[  , idx := .I ]
d201906[  , train :=  ( (idx %% 10) < 7 )]
d201906[ , idx:= NULL ]
d201906[ , azar:= NULL ]


dtrain  <- d201906[ train==TRUE ]
dtest   <- d201906[ train==FALSE ]
