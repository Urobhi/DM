...
dataset[ , rplazofijo_dolarestotal       :=  mplazo_fijo_dolares/rowSums(cbind(mplazo_fijo_dolares,mplazo_fijo_pesos), na.rm = TRUE)]
...
dataset[ , r_activos_pasivos       := rowSums(cbind(mcuentas_saldo,mplazo_fijo_dolares,mplazo_fijo_pesos,minversion1_dolares,
                                                    minversion1_pesos,minversion2), na.rm=TRUE ) / 
                                      rowSums(cbind(mprestamos_personales,mprestamos_prendarios,mprestamos_hipotecarios), na.rm=TRUE)  ]
...
fwrite( dataset, 
        ...
        sep="\t" )
save (dataset,
		file="./datasets/paquete_premium_exthist_corregido.RData")
