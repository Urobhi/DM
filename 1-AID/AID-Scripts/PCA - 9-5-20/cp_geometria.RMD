...
```{r echo=TRUE}
dir_root = "C:/Users/Pato/Google Drive/Data Mining/Materias/Analisis Inteligente de Datos/AID-Datasets/"
datos_crudos=read_xlsx(paste0(dir_root,"geometria.xlsx"),sheet = 1)
